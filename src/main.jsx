...
const AppWrapper = () => {
  ...
  document.body.classList.add(theme);
    ...
    if (theme === 'theme-custom') {
      ...
      root.style.setProperty('--btn-opacity', String(custom.btnOpacity ?? 1));
      root.style.setProperty('--text-size', (custom.textSize ?? 16) + 'px');
      root.style.setProperty('--bg-main', custom.bgMain || '#e5e5e5');
      root.style.setProperty('--accent', custom.accent || '#3939d9');
    } else {
